...
:root {
  ...
  --main-text-color: #563d7c;
  --second-text-color: #563d7c;
  --second-bg-color: #fcec5d;
}
...
<script src="https://code.jquery.com/jquery-3.6.0.js" integrity="sha256-H+K7U5CnXl1h5ywQfKtSj8PCmoN9aaq30gDh27Xc0jk=" crossorigin="anonymous"></script>
    ...
    $(document).on("click","#wrapper .list-group-item",function(){
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <a href="{{ url('/admin/home/dashboard') }}" class="list-group-item list-group-item-action bg-transparent fw-bold active"><i
                        class="fas fa-tachometer-alt me-2"></i>Dashboard</a>
                <a href="{{ url('/admin/babysitters') }}" class="list-group-item list-group-item-action bg-transparent fw-bold"><i
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0" id="dash">Dashboard</h2>
                </div>
            ...
            <div class="container-fluid px-4">
                <div class="row g-3 my-2">
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2">{{$b_num}}</h3>
                                <p class="fs-5">Babysitters</p>
                            </div>
                            <i
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <h3 class="fs-2">{{$p_num}}</h3>
                                <p class="fs-5">parents</p>
                            </div>
                            <i class="fas fa-user fs-1 primary-text border rounded-full secondary-bg p-3"></i>
                        </div>
                    </div>
