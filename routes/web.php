...
Route::get('/babysitter/{id}/profile/detail','App\Http\Controllers\ProfileController@ShowSingleProfile')->name('babysitter.detail');
...
Route::group(['prefix' => 'admin', 'middleware'=>['auth','is_admin','preventBackHistory','verified']], function () {
    ...
    //  Route::get('/settings/bpay', 'App\Http\Controllers\SettingController@UpdateBpaySetting')->name('s1.post');
    // Route::get('/settings/ap', 'App\Http\Controllers\SettingController@UpdateApproveSetting')->name('s2.post');
});
